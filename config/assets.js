...
window.AssetConfig = {
  ...
  scenes: {
    ...
    friendCall:        { image: "assets/images/phone call.png",         ambience: "buzz",                        overlays: ["crt"] },
    friendCallAgain:   { image: "assets/images/phone call.png",         ambience: "dragging",                    overlays: ["crt"] },
    taxiCancelled:     { image: "assets/images/docking bay.png",        ambience: "buzz",                        overlays: ["fog", "crt"] },
    streetlights:      { image: "assets/images/street lights.png",      ambience: "dragging",                    overlays: ["fog", "rain", "crt"] },
    alley:             { gif:   "assets/images/alley.png",              ambience: "heartbeat",                   sfx: [{ id: "drag-metal", delay: 250, volume: 0.35 }], overlays: ["fog", "crt"] },
    deadLine:          { image: "assets/images/phone call.png",         ambience: "buzz",                        overlays: ["crt"] },
    theFog:            { image: "assets/images/lone road.png",          ambience: "wind",                        overlays: ["fog", "crt"] },
    convenienceStore:  { image: "assets/images/convenient store.png",   ambience: "buzz",                        overlays: ["crt"] },
    storeCharm:        { image: "assets/images/convenient store.png",   ambience: "rain",                        overlays: ["crt"] },
    storeBattery:      { image: "assets/images/convenient store.png",   ambience: "heartbeat",                   overlays: ["crt"] },
    storeGhost:        { image: "assets/images/convenient store.png",   ambience: "heartbeat",                   overlays: ["crt"] },
    mainRoad:          { image: "assets/images/lone road.png",          ambience: "wind",                        overlays: ["fog", "crt"] },
    park:              { image: "assets/images/park path.png",          ambience: "footsteps",                   overlays: ["fog", "crt"] },
    waiting:           { image: "assets/images/lone road.png",          ambience: "heartbeat",                   overlays: ["fog", "crt"] },
    apartmentDistrict: { image: "assets/images/apartment district.png", ambience: "buzz",                        overlays: ["fog", "crt"] },
    figure:            { image: "assets/images/street figure.png",      ambience: "heartbeat",                   overlays: ["fog", "crt"] },
    figureLight:       { image: "assets/images/street figure.png",      ambience: "buzz",                        overlays: ["fog", "crt"] },
    lobby:             { image: "assets/images/apartment lobby.png",    ambience: "buzz",                        overlays: ["crt"] },
    guard:             { image: "assets/images/apartment lobby.png",    ambience: "heartbeat",                   overlays: ["crt"] },
    guardTruth:        { image: "assets/images/apartment lobby.png",    ambience: "heartbeat",                   overlays: ["crt"] },
    stairs:            { image: "assets/images/the stairs.png",         ambience: "footsteps",                   overlays: ["crt"] },
    elevator:          { image: "assets/images/elevator.png",           ambience: "buzz",                        overlays: ["crt"] },
    hide:              { image: "assets/images/apartment lobby.png",    ambience: "dragging",                    overlays: ["crt"] },
    peephole:          { image: "assets/images/peephole.png",           ambience: "heartbeat",                   overlays: ["crt"] },
    endingCheck:       { image: "assets/images/peephole.png",           ambience: "heartbeat",                   overlays: ["crt"] },
    goodEnding:        { image: "assets/images/good end.png",           music: "ending",                         overlays: ["fog"] },
    badEnding:         { image: "assets/images/bad end.png",            ambience: "dragging",  music: "ending",  overlays: ["fog", "crt"] },
