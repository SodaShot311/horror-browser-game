...
window.AssetConfig = {
  ...
  scenes: {
    ...
    streetlights:      { image: "assets/images/street lights.png",      ambience: "streetlights",                    overlays: ["fog", "rain", "crt"] },
    alley:             { gif:   "assets/images/alley.png",              ambience: "rain",                   sfx: [{ id: "drag-metal", delay: 250, volume: 0.35 }], overlays: ["fog", "crt"] },
    deadLine:          { image: "assets/images/phone call.png",         ambience: "deadLine",                        overlays: ["crt"] },
    theFog:            { image: "assets/images/lone road.png",          ambience: "rain",                        overlays: ["fog", "crt"] },
    convenienceStore:  { image: "assets/images/convenient store.png",   ambience: "convenienceStore",                        overlays: ["crt"] },
